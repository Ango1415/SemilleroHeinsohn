...
public class ComicDTO implements Serializable {
	...
	public ComicDTO(String id, String nombre, String editorial, TematicaEnum tematicaEnum, String coleccion,
			Integer numeroPaginas, BigDecimal precio, String autores, Boolean color, EstadoEnum estadoEnum,
			Long cantidad) {
	...
	/**
	 * Método para ver todas los valores de los parametros en un objeto perteneciente a esta clase
