...
del /F /S /Q *.deployed
echo Copiando .ear
xcopy C:\Users\angel\OneDrive\Escritorio\Semillero Heinsohn\semillero-hbt\semillero-padre\semillero-ear\target\semillero-ear-1.0-SNAPSHOT.ear "C:\wildfly-15.0.1.Final\standalone\deployments"  
echo Ejecutando .bat
